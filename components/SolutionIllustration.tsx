type IllustrationType = "sih" | "ris" | "pacs" | "equipement" | "ingenierie" | "location";
...
function Ingenierie() {
  return (
    <>
      {/* aire d'hélipad */}
      <circle cx="34" cy="62" r="24" fill="none" stroke={FAINT} strokeWidth="2.5" />
      <path d="M25 51 V73 M25 62 H43 M43 51 V73" stroke={STROKE} strokeWidth="3" strokeLinecap="round" />
      {/* grue de chantier */}
      <path d="M66 78 V32 M66 32 H88 M84 32 L88 40" stroke={STROKE_LIGHT} strokeWidth="2" strokeLinecap="round" />
      <path d="M66 40 L84 32" stroke={FAINT} strokeWidth="1.5" />
      <path d="M84 32 V44" stroke={STROKE_LIGHT} strokeWidth="1.5" strokeDasharray="1 4" />
      <circle cx="84" cy="24" r="2.5" fill={ACCENT} className="animate-blink" />
    </>
  );
}
...
function Location() {
  return (
    <>
      {/* silhouette d'avion privé */}
      <path
        d="M14 46 L46 40 L70 24 C72 22.5 75 23.5 74.5 26 L68 42 L82 44 L86 48 L68 48 L58 58 L64 60 L62 63 L48 60 L40 66 L36 64 L40 56 L14 51 Z"
        fill="none"
        stroke={STROKE}
        strokeWidth="2.2"
        strokeLinejoin="round"
      />
      {/* toit / résidence */}
      <path d="M18 82 H46 V68 L32 58 L18 68 Z" fill="none" stroke={STROKE_LIGHT} strokeWidth="2.2" strokeLinejoin="round" />
      <path d="M27 82 V72 H37 V82" stroke={FAINT} strokeWidth="1.8" />
      <circle cx="76" cy="20" r="2.5" fill={ACCENT} className="animate-blink" />
    </>
  );
}
