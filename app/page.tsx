...
const STATS = [
  { value: "20+", label: "ans sur le terrain biomédical" },
...
const DOMAINS = [
  ...
  },
  {
    ...
    description:
      "Vente, installation, maintenance préventive et curative des équipements médicaux, industriels, de médecine nucléaire et de leurs consommables associés.",
    href: "/equipements",
    illustration: "equipement" as const,
  },
  {
    code: "05 — Ingénierie",
    title: "Hélipads, héliports & construction",
    description:
      "Étude et création d'hélipads et héliports équipés pour l'hélicoptère médicalisé, construction de bâtiments publics et privés.",
    href: "/ingenierie",
    illustration: "ingenierie" as const,
  },
  {
    code: "06 — Location",
    title: "Avion privé & résidence privée",
    description:
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-4 font-display text-3xl font-bold text-ink">
            Plusieurs métiers, une seule continuité de service
          </h2>
          <p className="mt-4 text-slate">
            Des logiciels qui structurent l&apos;information médicale aux
            équipements qui la produisent, jusqu&apos;aux infrastructures qui
            les accueillent — Rimed intervient sur l&apos;ensemble de la
            chaîne.
          </p>
        </div>
