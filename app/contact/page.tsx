        ...
        <div>
          ...
          <dl className="mt-10 space-y-6 border-t border-line pt-8">
            <div>
              ...
              <dd className="mt-1">
                <a href="mailto:serge.soh@rimedci.com" className="text-ink hover:text-rimed">
                  serge.soh@rimedci.com <br />
                  info@rimedci.com
                </a>
              </dd>
            </div>
            <div>
              ...
              <dd className="mt-1">
                <a href="tel:+2252227195077" className="text-ink hover:text-rimed">
                  +225 22 27 19 50 77
                </a>
              </dd>
            </div>
            <div>
              ...
              <dd className="mt-1 text-ink">Cocody angre 9e tranche star 14, Abidjan, Côte d&apos;Ivoire</dd>
            </div>
            <div>
