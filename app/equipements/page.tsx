      ...
      <section className="trace-grid border-b border-line">
        <div className="mx-auto max-w-6xl px-6 py-20">
          ...
          <p className="mt-6 max-w-xl text-lg text-slate">
            Rimed fournit et entretient les équipements médicaux couvrant tous les services d&apos;un centre hospitalier, industriels
        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-4 text-slate">
              Réactifs, pièces d&apos;usure et consommables médicaux
